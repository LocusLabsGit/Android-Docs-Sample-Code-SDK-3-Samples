...
class MapBasicsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LLConfiguration.singleton.preventInitialPanAndZoom = true
        initLocusMaps()
    ...
    private fun initLocusMaps() {
        ...
        LLDependencyInjector.singleton.onPOIURLClickedListener = object : LLOnPOIURLClickedListener {
            override fun onPOIURLClicked(url: String) {
                ...
                this@MapBasicsActivity.startActivity(intent)
            }
        }
    ...
    private fun mapReady() {
        ...
        llLocusMapsFragment.changeMapParams(LLLatLng(33.9411, -118.4044), "lax-south-lounges", 190)
    }
}