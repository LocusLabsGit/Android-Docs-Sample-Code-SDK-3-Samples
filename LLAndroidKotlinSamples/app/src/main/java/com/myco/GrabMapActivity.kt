...
class GrabMapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LLConfiguration.singleton.grabCustomerId = "abc2e5a1cdcebc486a6710b484aeaf9d"
        initLocusMaps()
    ...
    private fun initLocusMaps() {
        ...
        LLDependencyInjector.singleton.onPOIURLClickedListener = object : LLOnPOIURLClickedListener {
            override fun onPOIURLClicked(url: String) {
                ...
                this@GrabMapActivity.startActivity(intent)
            }
        }
